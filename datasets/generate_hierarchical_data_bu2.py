...
OUTPUT_FILE = "final_hierarchical_output_v3.jsonl" 
MAX_NEW_TOKENS = 2048
...
# --- 4. Master Prompt Template (with JSON Fencing) ---
...
4.  ★★★ **MAINTAIN EMOTIONAL COHERENCE:** The emotional direction of an utterance MUST be a logical progression from the previous one. Abrupt, unrealistic emotional shifts (e.g., from extreme anger to pure happiness in the next sentence) are forbidden. Emotions should evolve naturally throughout the dialogue. ★★★

**UTTERANCE-LEVEL VOCABULARY:**
{utterance_rules}

**FRAME-LEVEL VOCABULARY:**
{frame_rules}
  ...
  "directed_utterances": [
    {{
      ...
      "frame_level_directions": [
        {{"phrase": "let the animals down", "tag": "[cracked-voice]"}},
        {{"phrase": "somehow", "tag": "[whisper]"}}
      ],
      "generation_parameters": {{
        "speaking_rate": 0.80,
        "pitch_std": 0.10
      }},
      "final_zonos_vector": {{"Sadness": 1.0, "Fear": 0.3, "Neutral": -0.2}}
    }}
  ]
}}
"""
